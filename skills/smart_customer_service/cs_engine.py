...
class SmartCustomerServiceEngine:
    ...
    FAQ_DATA: List[Dict] = [
        ...
        # 信用卡 (4)
        {
            "intent": 4, "question": "如何申请信用卡？", "answer": "信用卡申请渠道：1.手机银行→信用卡→我要办卡；2.官方网站在线申请；3.网点柜台申请；4.合作渠道（某第三方支付平台、微信等）。需提供身份证、工作证明、收入证明等材料。",
        ...
        {
            "intent": 4, "question": "信用卡如何还款？", "answer": "还款方式：1.自动还款（绑定借记卡）；2.手机银行转账还款；3.ATM现金还款；4.网点柜台还款；5.某第三方支付平台/微信还款。建议设置自动还款避免逾期。",
